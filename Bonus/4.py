...
'''
accept a unsorted list divide the list into halves unil it can no longer be divided 
combine the smaller sorted lists into a new sorted list 
'''
...
#         left_partiton = merge_sort(left)
#         right_partition = merge_sort(right)
#         return merge(left_partiton, right_partition)   
